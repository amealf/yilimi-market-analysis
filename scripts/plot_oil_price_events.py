...
const colors={kline:"rgba(17,17,17,.44)",upFill:"rgba(255,255,255,.90)",downFill:"rgba(17,17,17,.42)",text:"#111827",legend:"#374151",muted:"#4b5563",dateLine:"rgba(0,0,0,.10)",frame:"rgba(17,17,17,.48)",weekend:"rgba(148,163,184,.045)"};
const series=[
